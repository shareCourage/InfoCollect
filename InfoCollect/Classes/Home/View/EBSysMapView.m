...
//
#define kImageName_MinusBtn    @"map_minus@2x"//没有3x图片，只能写死了
#define kImageName_PlusBtn     @"map_plus@2x"
...
{
    MAMapView *mapView = [PHUseInfo sharedPHUseInfo].maMapView;
...
- (void)addMinusAndPlusButton
{
    ...
    [minus setBackgroundImage:[UIImage imageNamed:kImageName_MinusBtn] forState:UIControlStateNormal];
    [plus  setBackgroundImage:[UIImage imageNamed:kImageName_PlusBtn] forState:UIControlStateNormal];
