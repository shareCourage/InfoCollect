...
//
#define kHeightOfMapView kHeightOfScreen > 480 ? 250 : 200
...
- (void)titleViewImplementation {
    ...
    searchBtn.frame = CGRectMake(0, 0, kWidthOfScreen, 35);
...
- (void)searchMapViewImplementation {
    EBSearchMapView *mapView = [[EBSearchMapView alloc] initWithFrame:CGRectMake(0, kHeightOfNavigationBar, kWidthOfScreen, kHeightOfMapView)];
